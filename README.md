...
git clone https://example.com/skills/professional-infographic-skill \
  "${SKILL_SKILLS_INSTALL_DIR:-$HOME/.agents/skills}/sgc-professional-infographic"
```
...
git clone https://example.com/skills/hanzi-lens-skill \
  "${SKILL_SKILLS_INSTALL_DIR:-$HOME/.agents/skills}/sgc-hanzi-lens"
```
...
```bash
SKILL_DIR="${SKILL_SKILLS_INSTALL_DIR:-$HOME/.agents/skills}/sgc-hanzi-lens"
