...
- 调用 `lovstudio-professional-infographic` 生成可编辑 HTML/SVG 与高清 PNG；
- 同时执行汉字领域审计和专业信息图审计；
- 在全尺寸与缩略图下完成人工视觉复核。
...
git clone https://github.com/lovstudio/hanzi-lens-skill \
  "${LOVSTUDIO_SKILLS_INSTALL_DIR:-$HOME/.agents/skills}/lovstudio-hanzi-lens"
```
...
```bash
SKILL_DIR="${LOVSTUDIO_SKILLS_INSTALL_DIR:-$HOME/.agents/skills}/lovstudio-hanzi-lens"
