...
compatibility: >
  ...
  glyph-coverage checks, and the lovstudio-professional-infographic dependency.
...
The dependency `lovstudio-professional-infographic` is mandatory. Read its
